//Thu Jan 09 2025 08:13:40 GMT+0000 (Coordinated Universal Time)
...
class UserInfo {
  ...
  async ["ydxx"]() {
    ...
    try {
      ...
      if (_0x2ca6ea.code == 0) {
        console.log("账号[" + this.index + "]:喜马拉雅极速版开宝箱获得：" + _0x2ca6ea.data.score);
        await this.ydxxsp();
      } else {
        if (_0x2ca6ea.msg == "设备异常，请更换设备后重试") {
          await this.ydxx();
        }
        this.cFlag = false;
      }
  ...
  async ["ydxxsp"]() {
    ...
    try {
      ...
      if (_0x3a5fc5.code == 0) {
        console.log("账号[" + this.index + "]:喜马拉雅极速版开宝箱视频获得：" + _0x3a5fc5.data.score);
      } else {
        if (_0x3a5fc5.msg == "设备异常，请更换设备后重试") {
          await this.ydxxsp();
        }
        this.cFlag = false;
      }
  ...
  async ["yddttl"]() {
    let _0x206fd4 = String(Date.parse(new Date())),
      _0x55decb = rsaencrypt("stageIds=[" + this.tjid + "]&receiveType=1&currentDayReadTime=35907&timestamp=" + _0x206fd4);
    try {
      ...
      if (_0x534159.code == 0) {
        console.log("账号[" + this.index + "]:喜马拉雅极速版答题体力：" + _0x534159.data.stamina);
      } else {
        _0x534159.msg == "设备异常，请更换设备后重试" && (await this.yddttl());
        this.cFlag = false;
      }
    } catch (_0x41929a) {
      console.log("账号[" + this.index + "]", JSON.stringify(result));
  ...
  async ["yddt"]() {
    try {
      ...
      if (_0x5b8946.code == 0) {
        ...
        _0x5b8946.msg == "设备异常，请更换设备后重试" && (await this.yddt());
        this.cFlag = false;
      }
    } catch (_0x37783c) {
      console.log("账号[" + this.index + "]", JSON.stringify(result));
  ...
  async ["yddtlq"]() {
    ...
    try {
      ...
      if (_0x708c59.code == 0) {
        ...
        _0x708c59.msg == "设备异常，请更换设备后重试" && (await this.yddtlq());
        this.cFlag = false;
      }
    } catch (_0xe0109e) {
      console.log("账号[" + this.index + "]", JSON.stringify(result));
  ...
  async ["yddtlqfb"]() {
    let _0x4c0b1b = String(Date.parse(new Date())),
      _0x4bd0d5 = rsaencrypt("lastTopicId=763&numOfAnswers=3&receiveType=2");
    try {
      ...
      if (_0x2739cd.code == 0) {
        console.log("账号[" + this.index + "]:喜马拉雅极速版答题翻倍领取" + _0x2739cd.data.reward + "金币成功");
        await this.yddt();
      } else {
        _0x2739cd.msg == "设备异常，请更换设备后重试" && (await this.yddtlqfb());
        this.cFlag = false;
      }
    } catch (_0xed7fad) {
      console.log("账号[" + this.index + "]", JSON.stringify(result));
  ...
  async ["ydqd"]() {
    try {
      ...
      if (_0x336659.code == 0) {
        console.log("账号[" + this.index + "]:喜马拉雅极速版金币余额：" + _0x336659.data.creditAmount + " 现金余额：" + _0x336659.data.accountAmount + " 总收益：" + _0x336659.data.totalIncome + "元");
      } else {
  ...
  async ["qd"]() {
    ...
    try {
      ...
      if (_0x1aaaf1.code == 0) {
        console.log("账号[" + this.index + "]:喜马拉雅极速版签到成功 ");
      } else {
        console.log("账号[" + this.index + "]:喜马拉雅极速版信息：" + JSON.stringify(_0x1aaaf1));
        _0x1aaaf1.msg == "设备异常，请更换设备后重试" && (await this.ydqd());
        this.cFlag = false;
      }
    } catch (_0x57c615) {
      console.log("账号[" + this.index + "]", JSON.stringify(result));
  ...
  async ["appinit"]() {
    ...
    if (_0x18768b?.["data"]?.["imei"]) {
      console.log("账号[" + this.index + "]:喜马拉雅极速版新闻：生成 IMEI 成功 " + _0x18768b?.["data"]?.["imei"]);
      this.device = _0x18768b?.["data"]?.["imei"];
      await this.ydxwlb();
    } else {
      console.log("账号[" + this.index + "]:喜马拉雅极速版新闻：生成 IMEI 失败", JSON.stringify(_0x18768b));
    }
  }
  async ["ydxwlb"]() {
  ...
  async ["ydxw1"]() {
    let _0x5c5407 = String(Date.parse(new Date())),
      _0x1935e8 = AES_Encrypt("isX5Success=0&sdkversion=3.3.2.16&cuid=" + this.uid + "&imei=" + this.imei + "&oaid=" + this.imei + "&taskId=" + this.iiid + "&cid=530");
    try {
      ...
      if (_0x2197b9.code == 1 && _0x2197b9.msg == "ok") {
        console.log("账号[" + this.index + "]:喜马拉雅极速版新闻奖励领取成功：" + this.iiid);
      } else {
        console.log("账号[" + this.index + "]:喜马拉雅极速版新闻奖励领取：" + _0x2197b9.msg);
        this.cFlag = false;
      }
    } catch (_0x16985e) {
      console.log("账号[" + this.index + "]", JSON.stringify(result));
  ...
  async ["ydxw2"]() {
    let _0x39bb07 = String(Date.parse(new Date())),
      _0x48fcf0 = AES_Encrypt("cid=530&cuid=" + this.uid + "&sdkversion=3.3.2.16&imei=" + this.imei + "&adid=29&box_id=" + this.iiid + "&pos_code=yyz&h5_version=3.1.0");
    try {
  ...
  async ["ydlq"]() {
    ...
    try {
      ...
      if (_0x52e2a2.code == 0) {
        console.log("账号[" + this.index + "]:喜马拉雅极速版听书领金币：成功");
        await $.wait(1000);
        await this.ydlqsp();
      } else {
        _0x52e2a2.msg == "设备异常，请更换设备后重试" && (await this.ydlq());
        this.cFlag = false;
      }
    } catch (_0x4bdb67) {
      console.log("账号[" + this.index + "]", JSON.stringify(result));
  ...
  async ["ydlqsp"]() {
    ...
    try {
      ...
      if (_0x2b9da7.code == 0) {
        console.log("账号[" + this.index + "]:喜马拉雅听书翻倍视频：成功");
      } else {
        _0x2b9da7.msg == "设备异常，请更换设备后重试" && (await this.ydlqsp());
        this.cFlag = false;
      }
    } catch (_0x5afbf8) {
      console.log("账号[" + this.index + "]", JSON.stringify(result));
  ...
  async ["ydhs"]() {
    ...
    try {
      ...
      if (_0x6051dd.code == 0) {
        console.log("账号[" + this.index + "]:喜马拉雅极速版喝水" + this.tjid + "获得：" + _0x6051dd.data.score);
        await this.ydxxsp();
      } else {
        _0x6051dd.msg == "设备异常，请更换设备后重试" && (await this.ydhs());
        this.cFlag = false;
      }
    } catch (_0x38fbdf) {
      console.log("账号[" + this.index + "]", JSON.stringify(result));
  ...
  async ["ydhssp"]() {
    ...
    try {
      ...
      if (_0x125f74.code == 0) {
        ...
        _0x125f74.msg == "设备异常，请更换设备后重试" && (await this.ydhssp());
        console.log("账号[" + this.index + "]:喜马拉雅极速版喝水视频" + this.tjid + "：" + _0x125f74.msg);
        this.cFlag = false;
      }
    } catch (_0x42fb5e) {
      console.log("账号[" + this.index + "]", JSON.stringify(result));
  ...
  if (typeof $request !== "undefined") {
    ...
    if (userList.length > 0) {
      ...
      for (let _0x13969b of userList) {
        if (_0x13969b.cFlag) {
          taskall.push(_0x13969b.sh());
        }
        if (taskall.length > 50) {
...
async function checkEnv() {
  if (userCookie) {
    ...
    for (let _0x5f29fc of userCookie.split(_0xa521f6)) if (_0x5f29fc) {
      userList.push(new UserInfo(_0x5f29fc));
    }
  ...
  return new Promise(_0x1d39c8 => {
    $.send(_0x23ba52, _0x17bb3f, async (_0x11c106, _0x589ebf, _0x11c5f2) => {
      try {
        ...
        if (_0x11c106) {} else {
          if (_0x11c5f2.body) {
            if ("object" == typeof _0x11c5f2.body) {
...
function MD5Encrypt(_0x116e24) {
  ...
  function _0xb19ed9(_0x4c7ffc, _0x94da22) {
    ...
    _0x42839c = 2147483648 & _0x4c7ffc;
    _0x557d54 = 2147483648 & _0x94da22;
    _0x25744c = 1073741824 & _0x4c7ffc;
    _0x4c421e = 1073741824 & _0x94da22;
    _0x3c058e = (1073741823 & _0x4c7ffc) + (1073741823 & _0x94da22);
    return _0x25744c & _0x4c421e ? 2147483648 ^ _0x3c058e ^ _0x42839c ^ _0x557d54 : _0x25744c | _0x4c421e ? 1073741824 & _0x3c058e ? 3221225472 ^ _0x3c058e ^ _0x42839c ^ _0x557d54 : 1073741824 ^ _0x3c058e ^ _0x42839c ^ _0x557d54 : _0x3c058e ^ _0x42839c ^ _0x557d54;
  }
  ...
  function _0x2589ab(_0x22eafa, _0x4d3c00, _0x276345, _0x3bb01e, _0x118a93, _0xd0472b, _0x5acd1f) {
    _0x22eafa = _0xb19ed9(_0x22eafa, _0xb19ed9(_0xb19ed9(_0x39b92c(_0x4d3c00, _0x276345, _0x3bb01e), _0x118a93), _0x5acd1f));
    return _0xb19ed9(_0x3774a9(_0x22eafa, _0xd0472b), _0x4d3c00);
  }
  function _0x92b2f4(_0x2b12d6, _0x2a7b93, _0x4db11c, _0x2d8713, _0xa69262, _0x70a7da, _0x30e46c) {
    _0x2b12d6 = _0xb19ed9(_0x2b12d6, _0xb19ed9(_0xb19ed9(_0x5939c9(_0x2a7b93, _0x4db11c, _0x2d8713), _0xa69262), _0x30e46c));
    return _0xb19ed9(_0x3774a9(_0x2b12d6, _0x70a7da), _0x2a7b93);
  }
  function _0x5ddb46(_0x320cfe, _0x16bd98, _0x26f0d8, _0x302022, _0x7a673f, _0x2ecbf3, _0x2f4eeb) {
    _0x320cfe = _0xb19ed9(_0x320cfe, _0xb19ed9(_0xb19ed9(_0x3dcc32(_0x16bd98, _0x26f0d8, _0x302022), _0x7a673f), _0x2f4eeb));
    return _0xb19ed9(_0x3774a9(_0x320cfe, _0x2ecbf3), _0x16bd98);
  }
  function _0x17aa38(_0x756ba4, _0x112cac, _0x17e7da, _0x3f2805, _0x188807, _0x58e135, _0x2d9b72) {
    _0x756ba4 = _0xb19ed9(_0x756ba4, _0xb19ed9(_0xb19ed9(_0x32ffd4(_0x112cac, _0x17e7da, _0x3f2805), _0x188807), _0x2d9b72));
    return _0xb19ed9(_0x3774a9(_0x756ba4, _0x58e135), _0x112cac);
  }
  function _0x414225(_0x56481c) {
    for (var _0x4ae6c2, _0x3ae86a = _0x56481c.length, _0x467540 = _0x3ae86a + 8, _0x52b8dd = (_0x467540 - _0x467540 % 64) / 64, _0x4988c7 = 16 * (_0x52b8dd + 1), _0x327e9c = new Array(_0x4988c7 - 1), _0x197124 = 0, _0x30f9da = 0; _0x3ae86a > _0x30f9da;) {
      _0x4ae6c2 = (_0x30f9da - _0x30f9da % 4) / 4;
      _0x197124 = _0x30f9da % 4 * 8;
      _0x327e9c[_0x4ae6c2] = _0x327e9c[_0x4ae6c2] | _0x56481c.charCodeAt(_0x30f9da) << _0x197124;
      _0x30f9da++;
    }
    _0x4ae6c2 = (_0x30f9da - _0x30f9da % 4) / 4;
    _0x197124 = _0x30f9da % 4 * 8;
    _0x327e9c[_0x4ae6c2] = _0x327e9c[_0x4ae6c2] | 128 << _0x197124;
    _0x327e9c[_0x4988c7 - 2] = _0x3ae86a << 3;
    _0x327e9c[_0x4988c7 - 1] = _0x3ae86a >>> 29;
    return _0x327e9c;
  }
  function _0x784c37(_0x54b59a) {
    var _0x399809,
      ...
      _0x185dcf = "",
      _0x11e535 = "";
    for (_0x4a890b = 0; 3 >= _0x4a890b; _0x4a890b++) {
      _0x399809 = _0x54b59a >>> 8 * _0x4a890b & 255;
      _0x11e535 = "0" + _0x399809.toString(16);
      _0x185dcf += _0x11e535.substr(_0x11e535.length - 2, 2);
    }
    return _0x185dcf;
  }
  ...
  var _0x522e08,
    ...
    _0x23eb63 = 15,
    _0x4b1f00 = 21;
  for (_0x116e24 = _0x135e1b(_0x116e24), _0x40cfcd = _0x414225(_0x116e24), _0x57c7bf = 1732584193, _0x227293 = 4023233417, _0x46d2f8 = 2562383102, _0x1623f1 = 271733878, _0x522e08 = 0; _0x522e08 < _0x40cfcd.length; _0x522e08 += 16) {
    _0x2609a6 = _0x57c7bf;
    _0x5787dc = _0x227293;
    _0x190da8 = _0x46d2f8;
    _0x19a499 = _0x1623f1;
    _0x57c7bf = _0x2589ab(_0x57c7bf, _0x227293, _0x46d2f8, _0x1623f1, _0x40cfcd[_0x522e08 + 0], _0x5b1603, 3614090360);
    _0x1623f1 = _0x2589ab(_0x1623f1, _0x57c7bf, _0x227293, _0x46d2f8, _0x40cfcd[_0x522e08 + 1], _0x175e1f, 3905402710);
    _0x46d2f8 = _0x2589ab(_0x46d2f8, _0x1623f1, _0x57c7bf, _0x227293, _0x40cfcd[_0x522e08 + 2], _0xefe98a, 606105819);
    _0x57c7bf = _0x17aa38(_0x57c7bf, _0x227293, _0x46d2f8, _0x1623f1, _0x40cfcd[_0x522e08 + 8], _0xfabe2e, 1873313359);
    _0x1623f1 = _0x17aa38(_0x1623f1, _0x57c7bf, _0x227293, _0x46d2f8, _0x40cfcd[_0x522e08 + 15], _0x5d76ec, 4264355552);
    _0x46d2f8 = _0x17aa38(_0x46d2f8, _0x1623f1, _0x57c7bf, _0x227293, _0x40cfcd[_0x522e08 + 6], _0x23eb63, 2734768916);
    _0x227293 = _0x17aa38(_0x227293, _0x46d2f8, _0x1623f1, _0x57c7bf, _0x40cfcd[_0x522e08 + 13], _0x4b1f00, 1309151649);
    _0x57c7bf = _0x17aa38(_0x57c7bf, _0x227293, _0x46d2f8, _0x1623f1, _0x40cfcd[_0x522e08 + 4], _0xfabe2e, 4149444226);
    _0x1623f1 = _0x17aa38(_0x1623f1, _0x57c7bf, _0x227293, _0x46d2f8, _0x40cfcd[_0x522e08 + 11], _0x5d76ec, 3174756917);
    _0x46d2f8 = _0x17aa38(_0x46d2f8, _0x1623f1, _0x57c7bf, _0x227293, _0x40cfcd[_0x522e08 + 2], _0x23eb63, 718787259);
    _0x227293 = _0x17aa38(_0x227293, _0x46d2f8, _0x1623f1, _0x57c7bf, _0x40cfcd[_0x522e08 + 9], _0x4b1f00, 3951481745);
    _0x57c7bf = _0xb19ed9(_0x57c7bf, _0x2609a6);
    _0x227293 = _0xb19ed9(_0x227293, _0x5787dc);
    _0x46d2f8 = _0xb19ed9(_0x46d2f8, _0x190da8);
    _0x1623f1 = _0xb19ed9(_0x1623f1, _0x19a499);
  }
  ...
  return new class {
      ...
      if (/^@/.test(_0x353f6f)) {
        ...
        if (_0x7afc46) {
          try {
            ...
            _0x5a845b ? _0x44ee6b = this.lodash_get(_0x5a845b, _0x4bbd3e, "") : _0x44ee6b = _0x44ee6b;
          } catch (_0x587e9c) {
            _0x44ee6b = "";
          }
        }
    ...
    ["setdata"](_0xc5279, _0x1c5e3e) {
      ...
      if (/^@/.test(_0x1c5e3e)) {
        ...
        _0x4edbcf = this.setval(_0xc5279, _0x1c5e3e);
      }
      return _0x4edbcf;
    }
    ["getval"](_0x1bb894) {
    ...
    ["setval"](_0x32c094, _0x1de4bf) {
      return this.isSurge() || this.isLoon() ? $persistentStore.write(_0x32c094, _0x1de4bf) : this.isQuanX() ? $prefs.setValueForKey(_0x32c094, _0x1de4bf) : this.isNode() ? (this.data = this.loaddata(), this.data[_0x1de4bf] = _0x32c094, this.writedata(), true) : this.data && this.data[_0x1de4bf] || null;
    }
    ["send"](_0x4565ed, _0x450132, _0x2131c9 = () => {}) {
      ...
      if (_0x4565ed == "get" && _0x450132.headers) {
        delete _0x450132.headers["Content-Type"];
        delete _0x450132.headers["Content-Length"];
      } else {
        if (_0x450132.body && _0x450132.headers) {
          if (!_0x450132.headers["Content-Type"]) {
            _0x450132.headers["Content-Type"] = "application/x-www-form-urlencoded";
          }
        }
      }
      if (this.isSurge() || this.isLoon()) {
        if (this.isSurge() && this.isNeedRewrite) {
          _0x450132.headers = _0x450132.headers || {};
          Object.assign(_0x450132.headers, {
        ...
        if (this.isQuanX()) {
          _0x450132.method = _0x4565ed.toUpperCase();
          this.isNeedRewrite && (_0x450132.opts = _0x450132.opts || {}, Object.assign(_0x450132.opts, {
            "hints": false
          }));
    ...
    ["time"](_0x31bb3d) {
      ...
      if (/(y+)/.test(_0x31bb3d)) {
        _0x31bb3d = _0x31bb3d.replace(RegExp.$1, (new Date().getFullYear() + "").substr(4 - RegExp.$1.length));
      }
      for (let _0x36784e in _0x5d4be5) if (new RegExp("(" + _0x36784e + ")").test(_0x31bb3d)) {
        _0x31bb3d = _0x31bb3d.replace(RegExp.$1, 1 == RegExp.$1.length ? _0x5d4be5[_0x36784e] : ("00" + _0x5d4be5[_0x36784e]).substr(("" + _0x5d4be5[_0x36784e]).length));
      }
      return _0x31bb3d;
    }
    async ["showmsg"]() {
    ...
    ["msg"](_0xc269df = t, _0x16425b = "", _0x590a28 = "", _0x51cc15) {
      const _0x4915ff = _0x230434 => {
        ...
        if ("string" == typeof _0x230434) {
          return this.isLoon() ? _0x230434 : this.isQuanX() ? {
            "open-url": _0x230434
          } : this.isSurge() ? {
            "url": _0x230434
          } : undefined;
      ...
      if (_0x16425b) {
        _0x3973be.push(_0x16425b);
      }
      if (_0x590a28) {
        _0x3973be.push(_0x590a28);
      }
    ...
    ["json2str"](_0xf00c2f = {}) {
      ...
      if (_0xf00c2f.isSort) {
        _0x54f395 = _0x54f395.sort();
      }
      for (let _0x3d573d of _0x54f395) {
        let _0x3b9e91 = _0x503988[_0x3d573d];
        if (_0x3b9e91 && typeof _0x3b9e91 === "object") {
          _0x3b9e91 = JSON.stringify(_0x3b9e91);
        }
        if (_0x3b9e91 && _0xf00c2f.encodeUrl) {
          _0x3b9e91 = encodeURIComponent(_0x3b9e91);
        }
    ...
    ["str2json"](_0x42823e, _0x1b195c = false) {
      ...
      for (let _0x582b37 of _0x42823e.split("&")) {
        ...
        if (_0x1b195c) {
          _0x40cd7c = decodeURIComponent(_0x40cd7c);
        }
    ...
    ["randomPattern"](_0x54ba77, _0x326370 = "abcdef0123456789") {
      ...
      for (let _0x187b81 of _0x54ba77) {
        if (_0x187b81 == "x") {
          ...
          if (_0x187b81 == "X") {
            _0x114ae5 += _0x326370.charAt(Math.floor(Math.random() * _0x326370.length)).toUpperCase();
          } else {
            _0x114ae5 += _0x187b81;
          }
        }
    ...
    ["param2str"](_0x3ab377, _0x1bbd45 = true) {
      ...
      for (let _0x568060 in _0x3ab377) {
        if (typeof _0x3ab377[_0x568060] === "object") {
          _0x3ab377[_0x568060] = JSON.stringify(_0x3ab377[_0x568060]);
        }
        let _0x428907 = _0x3ab377[_0x568060];
        if (_0x1bbd45) {
          _0x428907 = escape(_0x428907);
        }
